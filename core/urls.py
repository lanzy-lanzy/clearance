...
urlpatterns = [
    ...
    path('staff/approve-request/<int:request_id>/', views.approve_clearance_request, name='approve_clearance_request'),
    path('staff/deny-request/<int:request_id>/', views.deny_clearance_request, name='deny_clearance_request'),

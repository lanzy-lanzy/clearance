# Generated by Django 5.1.5 on 2025-02-06 21:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('designation', models.CharField(choices=[('SET DEAN', 'SET DEAN'), ('STE DEAN', 'STE DEAN'), ('SOCJE DEAN', 'SOCJE DEAN'), ('SAFES DEAN', 'SAFES DEAN'), ('SSB SET', 'SSB SET'), ('SSB STE', 'SSB STE'), ('SSB SOCJE', 'SSB SOCJE'), ('SSB SAFES', 'SSB SAFES')], max_length=50)),
